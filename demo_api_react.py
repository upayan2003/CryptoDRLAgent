...
demo_api.py
===========
FastAPI backend for Crypto RL Agent demo.

Fixes applied vs previous version
-----------------------------------
1. Background threads now start in @app.on_event("startup") — not in
   __main__ — so Render.com actually launches them.
2. WebSocket replaced with REST polling — no asyncio conflicts.
3. OFI/TFI computed from REST bookTicker + aggTrades endpoint.
4. Feature buffer fills within 5 minutes (60 bars × 5 sec each).
"""
